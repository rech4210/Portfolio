...
/**
 * Ï∫êÎ¶≠?∞Ïùò ?§ÌÇ¨ ?¨Î°Ø?§ÏùÑ Í¥ÄÎ¶¨Ìïò??Aggregate Root ??ï†???òÎäî Ïª¥Ìè¨?åÌä∏?ÖÎãà??
 * DDD ?êÏπô???∞Îùº Î∂àÎ? Ï°∞Í±¥??Î≥¥Ïû•?òÍ≥† ?ÑÎ©î???¥Î≤§?∏Î? Î∞úÌñâ?©Îãà??
 */
...
public:
	...
	// ?§ÌÇ¨ ?ÅÌÉúÍ∞Ä Î≥ÄÍ≤ΩÎê† ???∏Ï∂ú?òÎäî ?¥Î≤§??(?±Î°ù, ?úÍ±∞, ?§Ïôë ??
